...
#from threestudio.models.deformation.cage_utils.mesh2cage import GenCage
...
def main(args, extras) -> None:
    ...
    dm = threestudio.find(cfg.data_type)(cfg.data, fix_camera=args.fix_camera)
    ...
    elif args.export_cage:
        set_system_status(system, cfg.resume)
        cage_system: BaseCage = threestudio.find(cfg.cage.cage_type)(
            cfg, 
        )
        cage_system()
...
if __name__ == "__main__":
    ...
    group.add_argument("--export_cage", action="store_true")
    ...
    parser.add_argument(
        "--fix_camera", action="store_true", help="if true, run in gradio mode"
    )
